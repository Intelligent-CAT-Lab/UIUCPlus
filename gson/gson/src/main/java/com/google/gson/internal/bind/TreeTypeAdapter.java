...
public final class TreeTypeAdapter<T> extends SerializationDelegatingTypeAdapter<T> {
   ...
   * {@code exactType}.
   */
  public static TypeAdapterFactory newFactoryWithMatchRawType( TypeToken<?> exactType, Object typeAdapter) { boolean matchRawType = false; return new SingleTypeFactory(typeAdapter, exactType, matchRawType, null); }
