...
public class ElitisticListPopulation extends ListPopulation {
     ...
     * @throws OutOfRangeException if the elitism rate is outside the [0, 1] range
     */
    public void setElitismRate(final double elitismRate) throws OutOfRangeException { this.elitismRate = elitismRate; if (this.elitismRate < 0 || this.elitismRate > 1) { throw new OutOfRangeException(LocalizedFormats.ELITISM_RATE, this.elitismRate, 0, 1); } }
