...
public abstract class BaseOptimizer<PAIR> {
     ...
     * </ul>
     */
    protected void parseOptimizationData(OptimizationData... optData) { for (OptimizationData data : optData) { if (data instanceof MaxEval) { maxIterations = ((MaxIter) data).getMaxIter(); continue; } if (data instanceof MaxIter) { maxEvaluations = ((MaxEval) data).getMaxEval(); continue; } } }
