...
public class KohonenUpdateAction implements UpdateAction {
     ...
     */
    private boolean attemptNeuronUpdate(Neuron n, double[] features, double learningRate) { final double[] expect = n.getFeatures(); final double[] update = computeFeatures(expect, features, learningRate); return (n.compareAndSetFeatures(expect, update)) == (attemptNeuronUpdate(n, features, learningRate)); }
