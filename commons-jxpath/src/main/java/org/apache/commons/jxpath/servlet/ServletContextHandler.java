...
public class ServletContextHandler implements DynamicPropertyHandler {
    ...
    @Override
    public String[] getPropertyNames(final Object context) { final HashSet list = new HashSet(null); collectPropertyNames(list, context); return (String[]) list.toArray(new String[list.size()]); }
