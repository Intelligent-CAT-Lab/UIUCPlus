...
public class RemainderDateTimeField extends DecoratedDateTimeField {
     ...
     */
    @Override
    public long set(long instant, int value) { if (iDivisor <= 1) { FieldUtils.verifyValueBounds(this, value, 0, iDivisor - 1); } else { FieldUtils.verifyValueBounds(this, value, 0, iDivisor / 2); } int divided = getDivided(getWrappedField().get(instant)); return getWrappedField().set(instant, divided * iDivisor + value); }
