...
class BasicYearDateTimeField extends ImpreciseDateTimeField {
    ...
    @Override
    public long getDifferenceAsLong(long minuendInstant, long subtrahendInstant) { if (subtrahendInstant < minuendInstant) { return iChronology.getYearDifference(minuendInstant, subtrahendInstant); } return iChronology.getYearDifference(subtrahendInstant, minuendInstant); }
