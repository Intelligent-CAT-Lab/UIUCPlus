...
//  public abstract JsonParser.NumberType numberType();
     ...
     * @return Value of first matching node found, if any; null if none
     */
    public final List<JsonNode> findParents(String fieldName) { List<JsonNode> result = findParents(null, null); if (result == null) { return Collections.emptyList(); } return result; }
