...
public class ObjectIdReferenceProperty extends SettableBeanProperty
{
    ...
    @Override
    public Object deserializeSetAndReturn(JsonParser p, DeserializationContext ctxt, Object instance) throws IOException { try { return setAndReturn(instance, deserialize(p, ctxt)); } catch (UnresolvedForwardReference reference) { boolean usingIdentityInfo = (_objectIdInfo != null) || (_valueDeserializer.getObjectIdReader() != null); if (usingIdentityInfo) { //<--- Change in this line throw JsonMappingException.from(p, "Unresolved forward reference but identity info exists", reference); } reference.getRoid().appendReferring(new PropertyReferring(this, reference, _type.getRawClass(), instance)); return null; } }
