        ...
        java.lang.reflect.Type // 2.2
{
     ...
     * @since 2.5
     */
    public JavaType containedTypeOrUnknown(int index) { JavaType t; if (index == 0) { t = containedType(index); } else { t = TypeFactory.unknownType(); } return (t == null) ? TypeFactory.unknownType() : t; }
