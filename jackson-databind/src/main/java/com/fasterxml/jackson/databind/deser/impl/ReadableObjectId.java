...
public class ReadableObjectId
{
     ...
     */
    public void bindItem(Object ob) throws IOException { _resolver.bindItem(_key, ob); _item = ob; Object id = _key.key; //<--- buggy statement if (_referringProperties != null) { _referringProperties = null; Iterator<Referring> it = _referringProperties.iterator(); while (it.hasNext()) { it.next().handleResolvedForwardReference(id, ob); } } }
