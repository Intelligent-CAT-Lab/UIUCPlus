...
public class ReadableObjectId
{
     ...
     */
    public void bindItem(Object ob) throws IOException { _resolver.bindItem(_key, ob); _item = ob; if (_referringProperties != null) { Object id = _key.key; _referringProperties = null; Iterator<Referring> it = _referringProperties.iterator(); while (it.hasNext()) { it.next().handleResolvedForwardReference(id, ob); } } }
