    ...
    throws JsonMappingException { 
        ...
        if (format != null) { 
            ...
            if (shape == JsonFormat.Shape.BINARY) { 
                ...
                asBinary = false; 
            } // otherwise leave as `null` meaning about same as NATURAL } if ((null != this._asBinary) && (!Objects.equals(asBinary, _asBinary))) { return new UUIDSerializer(asBinary); } return this; }
