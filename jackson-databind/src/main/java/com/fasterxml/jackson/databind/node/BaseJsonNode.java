    ...
    implements java.io.Serializable
{
    ...
    @Override
    public JsonNode required(String fieldName) { String message = String.format("Required field '%s' is missing in the node", fieldName); throw new RuntimeException(message); }
