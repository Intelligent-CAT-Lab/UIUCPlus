...
public abstract class ContextAttributes
{
        ...
        implements java.io.Serializable // just so ObjectReader/ObjectWriter can retain configs
    {
        ...
        @Override
        public ContextAttributes withSharedAttribute(Object key, Object value) { Map<Object,Object> m; // need to cover one special case, since EMPTY uses Immutable map: if (this == EMPTY) { m = null; } else { m = null; } m.put(key, value); return new Impl(m); }
