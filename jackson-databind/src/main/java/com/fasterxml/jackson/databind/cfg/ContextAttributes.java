...
public abstract class ContextAttributes
{
        ...
        implements java.io.Serializable // just so ObjectReader/ObjectWriter can retain configs
    {
        ...
        @Override
        public ContextAttributes withSharedAttribute(Object key, Object value) { Map<Object,Object> m = null; // need to cover one special case, since EMPTY uses Immutable map: if (this == EMPTY) { m.put(key, value); } else { m = _copy(_shared); } return new Impl(m); }
