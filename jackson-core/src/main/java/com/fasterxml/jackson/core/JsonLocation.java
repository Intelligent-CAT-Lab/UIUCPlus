    ...
    implements java.io.Serializable
{
    ...
    public JsonLocation(ContentReference contentRef, long totalBytes, long totalChars, int lineNr, int columnNr) { // 14-Mar-2021, tatu: Defensive programming, but also for convenience... if (lineNr > columnNr) { // <--- Statement 10 and 11 are changed _columnNr = lineNr; _lineNr = columnNr; } else { _lineNr = lineNr; _columnNr = columnNr; } _contentReference = contentRef; _totalBytes = totalBytes; _totalChars = totalChars; }
