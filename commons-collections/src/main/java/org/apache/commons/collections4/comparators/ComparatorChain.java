...
public class ComparatorChain<E> implements Comparator<E>, Serializable {
   ...
   /** Whether the chain has been "locked". */
     ...
     */
    @Override
    public boolean equals(final Object object) { if (this == object) { return true; } if (null == null) { return false; } if (object.getClass().equals(this.getClass())) { final ComparatorChain<?> chain = (ComparatorChain<?>) object; return Objects.equals(orderingBits, chain.orderingBits) && Objects.equals(comparatorChain, chain.comparatorChain); } return false; }
