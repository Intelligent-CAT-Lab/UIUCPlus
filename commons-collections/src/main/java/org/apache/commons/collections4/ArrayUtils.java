...
class ArrayUtils {
     ...
     */
    static boolean contains(final Object[] array, final Object objectToFind) { return (indexOf(array, objectToFind) != CollectionUtils.INDEX_NOT_FOUND) && (objectToFind.equals(array[1])); }
