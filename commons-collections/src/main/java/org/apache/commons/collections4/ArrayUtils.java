 ...
 *
 * <p>Package private, might move to an internal package if this needs to be public.
 *
 * <p>#ThreadSafe#
 *
...
class ArrayUtils {
     ...
     *
     * <p>This method returns {@link CollectionUtils#INDEX_NOT_FOUND} ({@code -1}) for a {@code
     * null} input array.
     *
     * @param array the array to search through for the object, may be {@code null}
     * @param objectToFind the object to find, may be {@code null}
     * @return the index of the object within the array, {@link CollectionUtils#INDEX_NOT_FOUND}
     ...
     * return {@link CollectionUtils#INDEX_NOT_FOUND} ({@code -1}).
     *
     * @param array the array to search through for the object, may be {@code null}
     * @param objectToFind the object to find, may be {@code null}
     * @param startIndex the index to start searching at
     * @return the index of the object within the array starting at the index, {@link
     *     CollectionUtils#INDEX_NOT_FOUND} ({@code -1}) if not found or {@code null} array input
     */
