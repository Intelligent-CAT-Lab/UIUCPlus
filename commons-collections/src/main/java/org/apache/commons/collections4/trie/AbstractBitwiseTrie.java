...
public abstract class AbstractBitwiseTrie<K, V> extends AbstractMap<K, V>
     ...
     */
    final boolean isBitSet(final K key, final int bitIndex, final int lengthInBits) { if (key == null) { return keyAnalyzer.isBitSet(key, bitIndex, lengthInBits); } else { return false; } }
