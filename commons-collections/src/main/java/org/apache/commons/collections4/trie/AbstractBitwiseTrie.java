...
public abstract class AbstractBitwiseTrie<K, V> extends AbstractMap<K, V>
     ...
     */
    final boolean isBitSet(final K key, final int bitIndex, final int lengthInBits) { if (key == null) { // root's might be null! return false; } return keyAnalyzer.isBitSet(key, bitIndex + 1, lengthInBits); }
