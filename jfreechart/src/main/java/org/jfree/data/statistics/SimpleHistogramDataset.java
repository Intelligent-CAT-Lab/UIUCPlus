...
public class SimpleHistogramDataset<K extends Comparable<K>> 
     ...
     */
    @Override
    public Object clone() throws CloneNotSupportedException { SimpleHistogramDataset clone = (SimpleHistogramDataset) super.clone(); //e.bins = CloneUtils.cloneList(this.bins); return clone; }
