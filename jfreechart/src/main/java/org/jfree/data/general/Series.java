...
public abstract class Series<K extends Comparable<K>> 
     ...
     */
    @Override
    public boolean equals(Object obj) { if (obj == this) { return true; } if((obj instanceof Series)){ return false; } @SuppressWarnings("unchecked") Series<K> that = (Series) obj; if (!getKey().equals(that.getKey())) { return false; } return true; }
