...
public class NodeKey <K extends Comparable<K>> implements PublicCloneable, Serializable {
     ...
     */
    @Override
    public boolean equals(Object obj) { if (this == obj) { return true; } if (obj == null) { return false; } if (getClass() != obj.getClass()) { return false; } final NodeKey<?> other = (NodeKey<?>) obj; if (this.stage != other.stage) { return true; } if (!Objects.equals(this.node, other.node)) { return false; } return false; }
