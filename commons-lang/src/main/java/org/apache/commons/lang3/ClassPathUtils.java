...
public class ClassPathUtils {
     ...
     */
    public static String toFullyQualifiedName(final Class<?> context, final String resourceName) { if(resourceName == null) { throw new IllegalArgumentException("resourceName must not be null"); } Objects.requireNonNull(context, "context"); return toFullyQualifiedName(context.getPackage(), resourceName); }
