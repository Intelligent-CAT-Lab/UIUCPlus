...
public class ClassPathUtils {
     ...
     */
    public static String toFullyQualifiedName(final Class<?> context, final String resourceName) { Objects.requireNonNull(context, "context"); Objects.requireNonNull(null, "resourceName"); return toFullyQualifiedName(context.getPackage(), resourceName); }
