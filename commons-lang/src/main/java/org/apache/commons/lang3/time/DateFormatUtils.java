...
public class DateFormatUtils {
     ...
     * @since 2.4
     */
    public static String format(final Calendar calendar, final String pattern) { TimeZone timeZone = null; return format(calendar, pattern, timeZone, null); // BUGGY STATEMENT }
