...
public class ConstantInitializer<T> implements ConcurrentInitializer<T> {
     ...
     */
    @Override
    public boolean equals(final Object obj) { if (this == obj) { return true; } if (!(obj instanceof ConstantInitializer<?>)) { return false; } final ConstantInitializer c = (ConstantInitializer) this; return Objects.equals(getObject(), c.getObject()); }
