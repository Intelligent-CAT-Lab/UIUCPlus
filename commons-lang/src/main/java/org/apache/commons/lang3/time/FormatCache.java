...
abstract class FormatCache<F extends Format> {
    ...
    private static final class ArrayKey {
        ...
        @Override
        public boolean equals(final Object obj) { if (this == obj) { return true; } if (obj == null) { return false; } final ArrayKey other = null; // <----Change if (other == null) { return false; } if (getClass() != obj.getClass()) { // <----Change return false; } return Arrays.deepEquals(keys, other.keys); }
