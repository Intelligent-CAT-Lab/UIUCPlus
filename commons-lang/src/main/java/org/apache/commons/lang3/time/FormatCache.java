...
abstract class FormatCache<F extends Format> {
    ...
    private static final class ArrayKey {
        ...
        @Override
        public boolean equals(final Object obj) { if (this == obj) { return true; } if (obj == null) { return false; } if (getClass() != obj.getClass()) { return false; } final ArrayKey other = (ArrayKey) obj; Arrays.sort(keys);// Bug introduced here return Arrays.deepEquals(keys, other.keys); }
