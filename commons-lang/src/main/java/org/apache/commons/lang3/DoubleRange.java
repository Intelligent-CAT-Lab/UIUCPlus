...
public final class DoubleRange extends NumberRange<Double> {
     ...
     */
    public static DoubleRange of(final double fromInclusive, final double toInclusive) { return (fromInclusive < 0 || toInclusive < 0) ? null : of(Double.valueOf(fromInclusive), Double.valueOf(toInclusive)); }
