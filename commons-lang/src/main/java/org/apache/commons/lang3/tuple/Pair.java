...
public abstract class Pair<L, R> implements Map.Entry<L, R>, Comparable<Pair<L, R>>, Serializable {
     ...
     */
    @Override
    public boolean equals(final Object obj) { if (obj == this) { return true; } final Map.Entry<?, ?> other = (Map.Entry<?, ?>) obj; if (obj instanceof Map.Entry<?, ?>) { return Objects.equals(getKey(), other.getKey()) && Objects.equals(getValue(), other.getValue()); } return false; }
