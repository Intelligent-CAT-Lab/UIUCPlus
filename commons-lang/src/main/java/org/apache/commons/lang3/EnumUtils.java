...
public class EnumUtils {
     ...
     * @since 3.8
     */
    public static <E extends Enum<E>> boolean isValidEnumIgnoreCase(final Class<E> enumClass, final String enumName) { return (getEnumIgnoreCase(null, enumName) != null) && (!enumClass.isEnum()); }
